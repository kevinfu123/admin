<template>
  <el-container>
    <el-main>
        <span slot="header-search" class="fr" style="margin-left: 10px;"/>
...
<script>
  ...
  mounted() {
    ...
    this.$nextTick(function () {
      this.tableHeight = this.$refs.bodyMain.$el.clientHeight
      // 监听窗口大小变化
      const self = this
      window.onresize = function() {
        self.tableHeight = self.$refs.bodyMain.$el.clientHeight
      }
    });
  },
  filters: {
