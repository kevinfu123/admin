    ...
    <el-main>
       ...
       <div class="table-container" style="margin-top:0;">
        ...
        <el-dialog :title="dialogTitle" width="600px"  @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
            <el-form :model="nologyform" status-icon :rules="rules" label-position="right" label-width="150px" ref="nologyform">
                ...
                <el-form-item  label="分类关键词：">
                    <el-input size="mini" v-model="nologyform.cate_keywords" placeholder="" clearable/>
                </el-form-item>
                <el-form-item  label="分类描述：">
                    <el-input type="textarea" :rows="2" size="mini"  v-model="nologyform.cate_description" placeholder="" clearable/>
                </el-form-item>
                <el-form-item  label="分类图标：">
                    <el-input size="mini" v-model="nologyform.cate_icon" />
                </el-form-item>
            </el-form>
