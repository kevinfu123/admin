<template>
  <div :class="{fullscreen:fullscreen}" class="tinymce-container editor-container">
    ...
    <div class="editor-custom-btn-container">
      ...
      <editorvideo color="#1890ff" class="editor-upload-btn" @successCBK="videoSuccessCBK"></editorvideo>
    </div>
  </div>
</template>
 ...
 `advlist anchor autolink autosave code codesample colorpicker colorpicker
  ...
  export default {
    ...
    methods: {
      ...
      videoSuccessCBK(arr) {
        const _this = this
        window.tinymce.get(_this.tinymceId).insertContent(`<video class="wscnph" src="${v.url}" >`)
      }
    },
    destroyed() {
      this.destroyTinymce()
