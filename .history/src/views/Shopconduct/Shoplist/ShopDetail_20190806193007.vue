...
<div class="app-container">
                        ...
                        <el-col :span="24">
                            ...
                            <div class="user-person">
                                ...
                                <p style="margin-top:20px;margin-left: 80px;padding-bottom: 60px;">
                                    ...
                                    <el-button @click="dialogFormVisible = true" type="primary" style="margin-left:25px;">审核不通过</el-button>
                                </p>
    ...
    <!-- 审核弹窗 -->
    <el-dialog title="审核操作" width="500px" @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
    ...
    <el-dialog title="退回保证金" width="500px" @close="handleClose2" class="demo-ruleForm" :visible.sync="dialogFormVisible2">
        <el-form :model="formdata1" status-icon :rules="rules" label-position="right" label-width="120px" ref="ValidateForm1">
            <el-form-item label="可退还金额：">
                <span style="font-weight:bold;">{{formdata.Refundable}}</span>
            </el-form-item>
            <el-form-item prop="refund" label="退还金额：">
                <el-input  v-model="formdata.refund"></el-input>
            </el-form-item>
            <el-form-item prop="account" label="到账金额：">
                <el-input  v-model="formdata.account"></el-input>
            </el-form-item>
