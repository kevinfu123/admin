  ...
  <div class="app-container app-head">
    ...
    <div class="table-container">
      <el-table ref="returnApplyTable"
        ...
        <el-table-column label="店铺推荐" width="80" align="center">
          <template slot-scope="scope">
            <el-switch
              v-model="row.restatus"
        ...
        <el-table-column label="技术费率免费额度" width="160" align="center">
        ...
        <el-table-column fixed="right" label="操作" width="200" align="center">
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.Freequota ==0" @click="handleClick(scope.row)" type="text" size="small">设置免费额度</el-button>
            <el-button v-if="scope.row.Freequota==='1'" @click="handleClick(scope.row)" type="text" size="small">开通店铺</el-button>
    ...
    data() {
      return {
        ...
        list: [{id: 12, memberId: 1,phoneNO: "13957203844",memberUsername: "test",Username: "test2",renType: '1',shopname: "鼎盛广告传媒",
                balanceAmount: 16377.75,examine:'1',status:'1',restatus:'0',
              ...
              {id: 13, memberId: 1,phoneNO: "13957203844",memberUsername: "test",Username: "test2",renType: '2',shopname: "阿里巴巴",
                balanceAmount: 16377.75,examine:'2',status:'3',restatus:'1',
              ...
              {id: 14, memberId: 1,phoneNO: "13957203844",memberUsername: "test",Username: "test2",renType: '1',shopname: "百度",
                balanceAmount: 16377.75,examine:'3',status:'2',restatus:'1',
