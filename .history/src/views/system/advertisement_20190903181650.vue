       ...
       <el-header style="height:auto; padding:0;">
          <el-form :inline="true" size="small" label-width="75px">
            ...
            <el-form-item label="广告位置">
              <el-select
                size="small"
                v-model="listQuery.ad_position_id" clearable placeholder="">
                <el-option
                  v-for="item in listdata1"
                  :key="item.value"
                  :label="item.label"
            ...
            <el-form-item label="广告来源">
              <el-select
                class="select2"
                size="small"
                v-model="listQuery.ad_source" clearable placeholder="">
                <el-option
            ...
            <el-form-item>
                <el-input size="small" placeholder="单位名称" v-model="listQuery.ad_name" clearable/>
            </el-form-item>
            <el-form-item>
                <el-button
                    type="primary"
...
<script>
    import {advertiseList, addadvertise, deleteadverltise, editadvertise} from '@/api/system/advertise';
    ...
    export default {
      ...
      methods:{
          getList() {
              this.listQuery.start_time = this.atd && this.atd.length>0?this.atd[0]:null
              this.listQuery.end_time = this.atd && this.atd.length>1?this.atd[1]:null
              advertiseList(this.listQuery).then((result) => {
              ...
              this.$refs[formName].validate((valid) => {
                  if (valid) {
                      if(this.nologyform.id){//编辑
                         ...
                         editadvertise(this.nologyform.id,adverjson).then((result) =>{
                            this.$message({
                                type: 'success',
                                message: '编辑成功!'
                            });
                          ...
                          addadvertise(this.nologyform).then((result) => {
                              this.$message({
                                  type: 'success',
                                  message: '新增成功!'
                              });
