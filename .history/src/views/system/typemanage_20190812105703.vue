    ...
    <el-main>
       ...
       <div class="table-container" style="margin-top:0;">
            <el-table
                ...
                border
                style="width: 100%">
                <el-table-column prop="id" label="分类名称" width="180" align="center">
                ...
                <el-table-column label="首页需求大厅是否展示" align="center">

                </el-table-column>
                <el-table-column
                label="排序" width="80" align="center">
                     技术费率 
                </el-table-column>
                <el-table-column label="技术费率" align="center">
