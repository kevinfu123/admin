                    ...
                    <template>
                        ...
                        <div class="bankall">
                            <el-table
                                ...
                                <el-table-column prop="BankAccount" label="银行卡账号" align="center">
                                </el-table-column>
                                <el-table-column prop="AccountName" label="开户户名"  align="center">
                                </el-table-column>
                                <el-table-column prop="branchBank" label="开户行支行名称" align="center">
                                </el-table-column>
...
export default {
    ...
    data() {
        return {
            ...
            tableData:[
                {id:1,operationdate:"2018-09-15T04:24:27.000+0000",Tmoney:400,OrderNo:1111111,Transaction:1,Transactiontype:1,balanceAmount:9527,
                tsm:"任务托管赏金"},
                {id:2,operationdate:"2018-09-15T04:24:27.000+0000",Tmoney:400,OrderNo:1111111,Transaction:2,Transactiontype:2,balanceAmount:9527,
                tsm:"任务托管赏金"},
                {id:3,operationdate:"2018-09-15T04:24:27.000+0000",Tmoney:400,OrderNo:1111111,Transaction:3,Transactiontype:3,balanceAmount:9527,
                tsm:"任务托管赏金"},
                {id:4,operationdate:"2018-09-15T04:24:27.000+0000",Tmoney:400,OrderNo:1111111,Transaction:4,Transactiontype:4,balanceAmount:9527,
                tsm:"任务托管赏金"},
                {id:5,operationdate:"2018-09-15T04:24:27.000+0000",Tmoney:400,OrderNo:1111111,Transaction:5,Transactiontype:5,balanceAmount:9527,
                tsm:"任务托管赏金"}
            ],
            pager:{
                page: 1,
