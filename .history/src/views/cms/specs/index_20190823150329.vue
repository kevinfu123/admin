            ...
            <div class="table-container" style="margin-top:0;">
              <el-table
                ...
                <el-table-column prop="" label="输入方式" width="180" align="center">
                   <template slot-scope="scope">
                    <el-tag type="success" size="mini" v-if="scope.row.input_type==0">
                        手动输入    
                    </el-tag>
                    <el-tag type="danger" size="mini" v-else-if="scope.row.input_type==1">
                        下拉列表选择
                    </el-tag>
                    </template>
                </el-table-column>
...
<script>
  ...
  import { specsList, deletespecs, editspecs, addspecs, servetype, updateApplyStatus} from '@/api/cms/specs';
  export default {
    name: 'specs',
    data() {
      return {
  ...
  methods: {
    ...
    //检索属性筛选类型
    radiooptional() {
      console.log(typeof this.nologyform)
