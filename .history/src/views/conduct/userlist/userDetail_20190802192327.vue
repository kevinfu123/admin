        ...
        <el-tab-pane label="账户资金明细" name="second">
            <template>
             <el-table
                ...
                <el-table-column prop="Transaction" label="交易项目"></el-table-column>
                <el-table-column prop="Transactiontype" label="交易类型"   width="180">
                </el-table-column>
                <el-table-column prop="Tmoney" label="交易金额">
                </el-table-column>
                <el-table-column prop="balanceAmount"label="账户余额" width="180">
                </el-table-column>
                <el-table-column prop="tsm"label="交易说明"></el-table-column>
            </el-table>
