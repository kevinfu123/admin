    ...
    <el-main>
       ...
       <div class="table-container" style="margin-top:0;">
            <el-table
                ...
                <el-table-column prop="is_hot" label="热门" width="60"  align="center">
                    <template slot-scope="scope">
                        <el-tag
                          :type="scope.row.is_hot == 1 ? 'danger' : 'success'"
                          disable-transitions>{{scope.row.paymentCode == 1 ? '是' : '否'}}</el-tag>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="状态" width="100"  align="center">
                    <template slot-scope="scope">
                        <el-switch
                        v-model="scope.row.is_show.toString()"
...
<script>
    import { serveList, deleteserve, editserve, addserve} from '@/api/serve/index';
