 ...
 `advlist anchor autolink autosave code codesample colorpicker colorpicker
  ...
  export default {
    ...
    methods: {
      ...
      videoSuccessCBK(url) {
        const _this = this
        window.tinymce.get(_this.tinymceId).insertContent(`<img class="mce-object mce-object-video" src="http://e.hiphotos.baidu.com/image/pic/item/4610b912c8fcc3cef70d70409845d688d53f20f7.jpg" width="300" height="150" data-mce-p-controls="controls" data-mce-html="%0A%3Csource%20src%3D%22blob%3Ahttps%3A//v.youku.com/71bc7a36-0895-4a45-9f75-17fc15b02182%22%20/%3E" data-mce-object="video">`)
      }
