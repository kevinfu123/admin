        ...
        <div  style="height:100%;">
          <el-container>
            <el-header style="height:auto; padding:0;">
              <el-form ref="searchForm" :model="searchForm" label-width="45px" class="el-row">
                <el-row :gutter="20">
                  <el-col :md="6" :lg="4" >
                    <el-form-item>
                  ...
                  <el-col :md="6" :lg="4" >
                    <el-form-item>
                      <el-input placeholder="ID、名称" v-model="searchForm.businessNo" clearable/>
                    </el-form-item>
                  </el-col>
                  <el-col :md="6" :lg="4">
                    <el-form-item>
                  ...
                  <el-col :md="6" :lg="4">
                    <el-form-item>
                      <el-button type="primary" size="mini" icon="el-icon-plus" @click="handleAddClick()">添加规格属性</el-button>
                    </el-form-item>
                  </el-col>
                </el-row>
              </el-form>
