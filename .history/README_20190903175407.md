...
`ltzmadmin`是一个电商后台管理系统的前端项目，基于Vue+Element实现。
...
- 访问在线接口无需搭建后台环境，只需将config/dev.env.js文件中的BASE_API改为[http://47.106.240.143/api/admin](http://47.106.240.143/api/admin)即可;
