        ...
        <el-tab-pane label="入驻技能" name="third">
            <template>
             <el-table
                ...
                <el-table-column fixed="right" label="操作" align="center">
                    <template slot-scope="scope">
                        <el-button size="medium" v-if="scope.row.paymentCode==='1'" @click="handleViewDetail(scope.$index, scope.row)">退回保证金</el-button>
                        <el-button class="button_medium" size="medium" v-if="scope.row.paymentCode==='0'" @click="handleViewDetail(scope.$index, scope.row)">确认缴纳</el-button>
                    </template>
                </el-table-column>
            </el-table>
