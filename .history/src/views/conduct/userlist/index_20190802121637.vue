      ...
      <el-table ref="returnApplyTable"
        ...
        <el-table-column label="实名认证" width="180" align="center">
          <template slot-scope="scope">
              <el-tag
                :type="scope.row.paymentCode === '1' ? 'danger' : 'success'"
                disable-transitions>{{scope.row.paymentCode === '1' ? 'Payable' : 'Receivable'}}</el-tag>
          </template>
        </el-table-column>
  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [{id: 12, 
                ...
                Username: "test2",
                renType: 0,
                UserNo: "201809150101000001",
                balanceAmount: 16377.75,
                },
              {id: 13, memberId: 1, couponId: 2, orderSn: "201809150102000002"},
              {id: 14, memberId: 1, couponId: 2, orderSn: "201809130101000001"},
              {id: 15, memberId: 1, couponId: 2, orderSn: "201809130102000002"},
              {id: 16, memberId: 1, couponId: 2, orderSn: "201809140101000001"},
              {id: 17, memberId: 1, couponId: 2, orderSn: "201809150101000003"},
              {id: 18, memberId: 1, couponId: 2, orderSn: "201809150102000004"},
              {id: 19, memberId: 1, couponId: 2, orderSn: "201809130101000003"},
              {id: 20, memberId: 1, couponId: 2, orderSn: "201809130102000004"},
              {id: 21, memberId: 1, couponId: 2, orderSn: "201809140101000002"}
              ],
        total:null,
        listLoading:false,
        multipleSelection:[],
    ...
    methods:{
      ...
      handleViewDetail(index,row){
        this.$router.push({path:'/conduct/userDetail',query:{id:row.id}})
      },
      handleBatchOperate(){
