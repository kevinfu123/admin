    ...
    <el-main>
       <el-header style="height:auto; padding:0;">
          <el-form :inline="true" size="small" label-width="80px">
            ...
            <el-form-item label="创建时间">
              <el-select
                size="small"
                v-model="searchForm.date" clearable placeholder="">
                <el-option
                  v-for="item in listdata1"
                  :key="item.value"
                  :label="item.label"
       ...
       <div class="table-container" style="margin-top:0;">
            <el-table
                ...
                border
                style="width: 100%">
                <el-table-column prop="bl_name" label="模板编号" width="120" align="center">
                </el-table-column>
                <el-table-column prop="grow_up_min" label="模板标题" align="center" />
                <el-table-column prop="grow_up_max"  label="模板内容" align="center" />
                ...
                <el-table-column prop="grow_up_max"  label="模板类型" align="center" />
...
<script>
    import {deleteshop, gradeList, addshop, editshop} from '@/api/system/temmanage';
    ...
    export default {
      ...
      methods:{
          ...
          handleSuccess1(response, file, fileList) {
             this.nologyform.icon = response.file
