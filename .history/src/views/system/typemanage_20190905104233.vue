           ...
           <ul class="role-table">
              ...
              <li class="role_li" v-for="(item,index) in dataList" :key="item.id">
                  ...
                  <ul v-show="item.children">
                      <li class="role_li" v-for="(itemchild,index) in item.children" :key="itemchild.id">
                          <div class="left left_frist text_left">
                              <i  v-cloak  class="item-icon"></i>
                              <span v-cloak>{{itemchild.cate_name}}</span>
                          </div>
                          <div class="left left1"></div>
                          <div class="left left2">{{itemchild.index_nav_show | statusFilter}}</div>
                          <div class="left left3">{{itemchild.index_nav_sort}}</div>
                          <div class="left left2">{{itemchild.floor_nav_show | floorFilter}}</div>
                          <div class="left left3">{{itemchild.floor_nav_sort}}</div>
                          <div class="left left2">
                              ——
                          </div>
                          <div class="left left3">{{itemchild.index_needs_sort}}</div>
                          <div class="right right1">——</div>
                          <div class="right right3">
                            ———
                          </div>
