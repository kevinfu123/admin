           ...
           <ul class="role-table">
              ...
              <li class="role_li" v-for="(item,index) in dataList" :key="item.id">
                  <div class="left left_frist text_left">
                      <i @click="togglefold(index,item)" :class="{'el-icon-caret-right':item.folded,'el-icon-caret-bottom':!item.folded}"
                  ...
                  <ul class="ul-child" v-show="isOpenItem[index] && isOpenItem[index].group">
                      <li class="childrole_li" v-for="(itemchild,j) in item.children" :key="itemchild.id">
                          <div class="left child_frist text_center">
                              <i @click="checkSecondItem(index,j)" :class="{'el-icon-caret-right':itemchild.folded,'el-icon-caret-bottom':!itemchild.folded}"
                               v-cloak  class="item-icon"></i>
                          ...
                          <!-- 三级级数据 v-show="isOpenItem[index] && isOpenItem[index].child[j]" -->
                          <div class="line"></div>
