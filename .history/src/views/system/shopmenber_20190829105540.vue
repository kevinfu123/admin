    ...
    <el-main>
       ...
       <div class="table-container" style="margin-top:0;">
            <el-table
                ...
                border
                style="width: 100%">
                <el-table-column prop="bl_name" label="会员等级名称" width="120" align="center">
                </el-table-column>
                <el-table-column prop="grow_up_min" label="会员等级标识" align="center" />
                ...
                <el-table-column prop="grow_up_max"  label="技术费率" align="center" />
                <el-table-column prop="grow_up_max"  label="允许发布服务" align="center" />
                <el-table-column prop="grow_up_max"  label="允许入驻类目" align="center" />
