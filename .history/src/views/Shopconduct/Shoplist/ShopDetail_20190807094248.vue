                        ...
                        <div class="shop-content">
                            <el-form ref="form" :model="sizeForm" label-width="100px" size="mini">
                                ...
                                <div class="div_bottom">
                                    <el-button size="small" type="primary" @click="open2">店铺审核通过</el-button>
                                    <el-button size="small" @click="dialogFormVisible = true" type="primary" style="margin-left:25px;">店铺审核不通过</el-button>
                                </div>
                            </el-form>
                        </div>
                    </el-col>
