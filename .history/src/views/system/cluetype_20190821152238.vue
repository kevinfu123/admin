    ...
    <el-main>
       ...
       <div class="table-container" style="margin-top:0;">
            <el-table
                ...
                <el-table-column prop="phone_price"  label="手机号价格" align="center">
                    <template slot-scope="scope">
                        <span style="color:red;">￥</span>{{scope.row.phone_price}}
                    </template>
                </el-table-column>
                <el-table-column prop="wechat_price"  label="微信价格" align="center">
                    <template slot-scope="scope">
                        <span style="color:red;">￥</span>{{scope.row.wechat_price}}
                    </template>
                </el-table-column>
                <el-table-column  label="qq价格" align="center">
                    <template slot-scope="scope">
                        <span style="color:red;">￥</span>{{scope.row.qq_price}}
                    </template>
                </el-table-column>
                <el-table-column  label="邮箱价格" align="center">
                    <template slot-scope="scope">
                        <span style="color:red;">￥</span>{{scope.row.email_price}}
                    </template>
                </el-table-column>
