       ...
       <div class="table-container" style="margin-top:0;">
           <ul class="role-table col-xs-offset-2 col-md-offset-1 col-sm-offset-2">
              <li class="header_li">
                  ...
                  <div class="right right1">保证金</div>
                  <div class="right right2">操作</div>
              </li>
              <li class="header_li" v-for="(item,index) in dataList" :key="item.id">
                  <div class="left left_frist">
                      <i 
...
<script>
    import {deletetype, typeList, addtype} from '@/api/system/typemanage';
