<template> 
  <div class="app-container app-head">
    ...
    <el-dialog :title="dialogTitle" width="500px" @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
        <el-form :model="nologyform" status-icon :rules="rules" label-position="right" label-width="130px" ref="ValidateForm">
        ...
        <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="quotaopen()">确 定</el-button>
        </div>
    </el-dialog>
    <!-- 关闭店铺弹窗 -->
    <el-dialog
    ...
    data() {
      return {
        rules: {
                ...
                quota:[{ required: true,type: 'number', message: '年龄必须为数字值'}]
            },
