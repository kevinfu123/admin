        ...
        <el-dialog :title="dialogTitle" width="35%"  @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
            <el-form :model="nologyform" status-icon :rules="rules" label-position="right" label-width="100px" ref="nologyform">
                ...
                <el-form-item label="热门：">
                    <el-radio-group @change="radiooptional" v-model="nologyform.is_hot">
                      <el-radio :label="1">是</el-radio>
                      <el-radio :label="0">否</el-radio>
                    </el-radio-group>
                </el-form-item>
                <el-form-item label="推荐：">
                    <el-radio-group @change="radiooptional" v-model="nologyform.is_recommend">
                      <el-radio :label="1">是</el-radio>
                      <el-radio :label="0">否</el-radio>
                    </el-radio-group>
                </el-form-item>
...
<script>
    ...
    export default {
      ...
      methods:{
          ...
          selectclick() {
               this.listdata = [];
               this.servefun(this.listQuery.cate_id_1);
          },
          handletype() {
