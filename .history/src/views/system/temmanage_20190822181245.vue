   ...
   <el-container>
    <el-main>
       ...
       <div class="table-container" style="margin-top:0;">
        ...
        <!-- 添加/编辑单位 -->
        <el-dialog :title="dialogTitle" style="width:600px;"  @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
            <el-form :model="nologyform" status-icon :rules="rules" label-position="right" label-width="100px" ref="nologyform">
                ...
                <el-form-item  label="模板内容：">
                    <Tinymce ref="editor" :height="400" style="width:100%;" v-model="nologyform.content" />
                </el-form-item>
                <el-form-item  label="模板类型：">
                    <el-select
                        size="mini"
