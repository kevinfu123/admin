          ...
          quotaopen1(formName){
              this.$refs[formName].validate((valid) => {
                  if (valid) {
                      ...
                      let  c_id = this.nologyform1.playtype2.value +'|'+ this.nologyform1.playtype3.value +'|'+ this.nologyform1.playtype4.value;
                      let  c_name = this.nologyform1.playtype2.lable +'->'+this.nologyform1.playtype3.lable +'->'+ this.nologyform1.playtype4.lable;
