   ...
   <el-container>
    <el-main>
       ...
       <div class="table-container" style="margin-top:0;">
        ...
        <!-- 添加/编辑单位 -->
        <el-dialog :title="dialogTitle" width="500px" :rules="rules" @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
            <el-form :model="nologyform" status-icon  label-position="right" label-width="80px" ref="nologyform">
                <el-form-item prop="quota"  label="单位：">
                    <el-input type="quota" v-model="nologyform.quota" placeholder="请输入单位" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
