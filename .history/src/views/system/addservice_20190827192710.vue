        ...
        <el-dialog :title="dialogTitle" width="35%"  @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
            <el-form :model="nologyform" status-icon :rules="rules" label-position="right" label-width="120px" ref="nologyform">
                <el-form-item prop="inc_name"  label="增值服务名称：">
                    <el-input size="mini" style="width:300px;"  v-model="nologyform.inc_name" placeholder="" clearable/>
                </el-form-item>
                <el-form-item prop="price" label="价格：">
                    <el-input size="mini" style="width:300px;"  v-model.number="nologyform.price" placeholder="" clearable/>
                </el-form-item>
                ...
                <el-form-item  label="排序：">
                    <el-slider :max="200" v-model="nologyform.sort"></el-slider>
                </el-form-item>
