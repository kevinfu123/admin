    ...
    <el-main>
       ...
       <div class="table-container" style="margin-top:0;">
            <el-table
                ...
                <el-table-column prop="pwidth" width="100" label="位置宽度" align="center" />
                <el-table-column prop="pheight" width="100" label="位置高度" align="center" />
                <el-table-column prop="Sources" width="120" label="广告描述" align="center" />
