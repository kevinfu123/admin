<template> 
  <div class="app-container app-head">
    ...
    <el-dialog :title="dialogTitle" width="500px" @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
        <el-form :model="nologyform" status-icon  :rules="[
          { required: true, message: '额度不能为空'},{ type: 'number', message: '额度为数字值'}]" 
         label-position="right" label-width="135px" ref="nologyform">
            <el-form-item prop="quota" label="技术费免费额度：">
                <el-input v-model.number="nologyform.quota" placeholder="请输入金额" autocomplete="off"></el-input>
            </el-form-item>
        </el-form>
