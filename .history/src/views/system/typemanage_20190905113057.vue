           ...
           <ul class="role-table">
              ...
              <li class="role_li" v-for="(item,index) in dataList" :key="item.id">
                  ...
                  <div class="right right2">
                      <el-button @click="handlemanage(item)" type="text" size="small">编辑</el-button>
                  ...
                  <ul class="ul-child" v-show="item.children">
                      <li class="childrole_li" v-for="(itemchild,index) in item.children" :key="itemchild.id">
                          ...
                          <div class="right childright2">
                              <el-button @click="handlemanage(itemchild)" type="text" size="small">编辑</el-button>
                              <el-button @click="handlelower(itemchild)" type="text" size="small">新增下级</el-button>
                          </div>
                          <!-- 三级级数据 -->
                          <div class="line"></div>
                          <ul class="ul-child-item" v-show="item.children.children">
                              <li class="last_role_li" v-for="(itemlast,index) in item.children.children" :key="itemlast.id">
                                  <div class="left last-child text_right">
                                      <span v-cloak>{{itemchild.cate_name}}</span>
                                  </div>
                                  <div class="left lastleft1">无</div>
                                  <div class="left lastleft2">{{itemchild.index_nav_show | statusFilter}}</div>
                                  <div class="left lastleft3">{{itemchild.index_nav_sort}}</div>
                                  <div class="left lastleft2">{{itemchild.floor_nav_show | floorFilter}}</div>
                                  <div class="left lastleft3">{{itemchild.floor_nav_sort}}</div>
                                  <div class="left lastleft2">
                                      ——
                                  </div>
                                  <div class="left lastleft3">{{itemchild.index_needs_sort}}</div>
                                  <div class="right lastright1">——</div>
