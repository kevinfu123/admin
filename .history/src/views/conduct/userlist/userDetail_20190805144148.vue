                    ...
                    <el-col :span="24">
                        ...
                        <div class="t-content">
                            ...
                            <el-col :span="16">
                                <div>
                                    <ul>
                                        <li><span class="user_info">用户编号：</span><span>t_9625_UGzjld</span></li>
                                        <li><span class="user_info">用户昵称：</span><span>设计云</span></li>
                                        <li><span class="user_info">姓名：</span><span>张美丽</span></li>
                                        <li><span class="user_info">账户余额：</span><span>22222222</span></li>
                                        <li><span class="user_info">生日：</span><span>1987-05-21</span></li>
                                        <li><span class="user_info">联系地址：</span><span>广东省深圳市宝安区  </span></li>
                                        <li><span class="user_info">联系电话：</span><span>1888888888666</span></li>
                                        <li><span class="user_info">QQ：</span><span>58823433</span></li>
                                        <li><span class="user_info">注册时间：</span><span>2019-07-01 12:34</span></li>
                                        <li><span class="user_info">微信：</span><span>jane58823433</span></li>
                                        <li><span class="user_info">用户来源：</span><span>PC端</span></li>
                                        <li><span class="user_info">email：</span><span>575313@qq.com</span></li>
                                    </ul>
                                </div>
                            </el-col>
                        </div>
