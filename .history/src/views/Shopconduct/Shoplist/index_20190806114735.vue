  ...
  <div class="app-container app-allhead">
    <el-card class="filter-container" shadow="never">
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="97px">
    ...
    <div class="table-container">
      <el-table ref="returnApplyTable"
        ...
        <el-table-column label="实名认证状态" width="180" align="center">
          <template slot-scope="scope">
                <el-tag type="danger" size="mini" v-if="scope.renType==='1'">
                    未申请   
                </el-tag>
                <el-tag type="success" size="mini" v-else-if="scope.renType==='2'">
                    已通过
                </el-tag>
                <el-tag type="info" size="mini" v-else-if="scope.renType==='3'">
                    未通过
                </el-tag>
                <el-tag  size="mini" v-else-if="scope.renType==='4'">
                    待审核
                </el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column label="申请审核状态" width="180" align="center">
          <template slot-scope="scope">
                <el-tag type="danger" size="mini" v-if="scope.examine==='1'">
                    待审核 
                </el-tag>
                <el-tag type="success" size="mini" v-else-if="scope.examine==='2'">
                    已通过
                </el-tag>
                <el-tag type="info" size="mini" v-else-if="scope.examine==='3'">
                    未通过
                </el-tag>
          </template>
        </el-table-column>
    ...
    data() {
      return {
        ...
        list: [{id: 12, memberId: 1,phoneNO: "13957203844",memberUsername: "test",Username: "test2",renType: 0,UserNo: "201809150101000001",
                balanceAmount: 16377.75,examine:'1',
