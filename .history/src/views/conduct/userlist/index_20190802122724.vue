  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="returnApplyTable"
                ...
                v-loading="listLoading" border>memberId: 1,phoneNO: "13957203844",memberUsername: "test",Username: "test2",renType: 0,UserNo: "201809150101000001",
        ...
        <el-table-column label="账户余额" width="180" align="center">
          <template slot-scope="scope">{{scope.row.balanceAmount | formatReturnAmount}}</template>
        </el-table-column>
