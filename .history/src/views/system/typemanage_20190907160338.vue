       ...
       <div class="table-container" style="margin-top:0;">
        ...
        <el-dialog :title="dialogTitle" width="700px"  @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button size="mini" type="primary" @click="manageopen('nologyform')">确 定</el-button>
            </div>
        </el-dialog>
    </el-main>
   </el-container>
      ...
      methods:{
        ...
        manageopen(formName) {
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    console.log(33333);
                    console.log(this.nologyform,this.nologyform.id)
                    if(this.nologyform.id!=null){//编辑
        ...
        handleSuccess1(response, file, fileList) {
            ...
            var obj1 = document.getElementsByClassName('el-upload-list');
