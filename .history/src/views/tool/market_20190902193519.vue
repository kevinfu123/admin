      ...
      <div style="">
        <el-form :model="toolform"  label-width="120px" style="width: 100%" size="small">
          ...
          <el-form-item  label="是否显示：">
              <template>
                <el-radio v-model="toolform.is_show"  :value="toolform.is_show">显示</el-radio>
                <el-radio v-model="toolform.is_show"  :value="toolform.is_show">不显示</el-radio>
              </template>
          </el-form-item>
        </el-form>
      </div>
    ...
    methods:{
      ...
      getList() {
        ...
        tool().then((result) => {
            ...
            //this.toolform.is_show = this.toolform.is_show.toString()
        }).catch((err) => {
