    ...
    <el-main>
       <el-header style="height:auto; padding:0;">
          <el-form :inline="true" size="small" label-width="80px">
            ...
            <el-form-item>
                <el-button type="primary" size="mini" icon="el-icon-plus" @click="handleAddClick()">添加领域</el-button>
            </el-form-item>
         </el-form>
       </el-header>
        ...
        <el-dialog :title="dialogTitle" width="500px"  @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
            <el-form :model="nologyform" status-icon :rules="rules" label-position="right" label-width="80px" ref="nologyform">
                <el-form-item prop="sr_name" label="领域：">
                    <el-input  v-model="nologyform.sr_name" placeholder="请输入领域" clearable/>
                </el-form-item>
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="fieldopen('nologyform')">确 定</el-button>
            </div>
        </el-dialog>
    </el-main>
   </el-container>
...
<script>
    import {deletefield, fieldList, addfield, editfield} from '@/api/system/sericefield';
    ...
    export default {
      ...
      data() {
        return {
            rules: {
                sr_name: [{ required: true, trigger: 'blur', message: '领域不能为空' }],
            },
      ...
      methods:{
          ...
          handleEdit(index, row) {
            ...
            this.nologyform.sr_name = row.sr_name;
              ...
              this.$refs[formName].validate((valid) => {
                  if (valid) {
                      if(this.nologyform.id){
                          let servicejson = {
                              sr_name:this.nologyform.sr_name,
                              sort:this.nologyform.sort,
                          }
                          editservice(this.nologyform.id,servicejson).then((result) => {
                              this.$message({
                                  type: 'success',
                                  message: '编辑成功!'
                              });
                         ...
                         addfield(this.nologyform).then((result) => {
                            this.$message({
                                type: 'success',
                                message: '添加成功!'
                            });
