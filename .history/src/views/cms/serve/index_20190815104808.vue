   ...
   <el-container>
    <el-main>
       ...
       <div class="table-container" style="margin-top:0;">
            ...
            <el-form :model="nologyform" status-icon :rules="rules" label-position="right" label-width="100px" ref="nologyform">
                ...
                <el-form-item  label="分类：">
                    <ul class="Annex" v-model="nologyform.cate_id">
                        <li v-for="(item, index) in nologyform.cate_id">
                            {{item.c_name}}; <span style="color:red;font-size: 20px;margin-left: 8px;">x</span>
                        </li>
                    </ul>
        ...
        <!-- 添加分类-->
        <el-dialog :title="dialogTitle" width="25%"  class="demo-ruleForm" :visible.sync="dialogFormVisible1">
            <el-form :model="nologyform" status-icon :rules="rules" label-position="right" label-width="100px" ref="nologyform1">
