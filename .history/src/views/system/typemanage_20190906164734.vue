            ...
            typeList(this.listQuery).then((result) => {
              ...
              for (let i = 0; i < len; i++) {
                  ...
                  for (let j in this.dataList[i].children) {
                      ...
                      // this.$set(this.optiontype[i].children[j],'value',this.dataList[i].children[j].id);
                      // this.$set(this.optiontype[i].children[j],'label',this.dataList[i].children[j].cate_name);
                      // for(let k in this.dataList[i].children[j].children) {
                      //   this.$set(this.optiontype[i].children[j].children[k],'value',this.dataList[i].children[j].children[k].id);
                      //   this.$set(this.optiontype[i].children[j].children[k],'label',this.dataList[i].children[j].children[k].cate_name);
                      // }
                  }
              }
