        ...
        <el-dialog :title="dialogTitle" width="500px"  @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
            <el-form :model="nologyform" status-icon :rules="rules" label-position="right" label-width="80px" ref="nologyform">
                <el-form-item prop="quota" label="广告名称：">
                    <el-input  v-model="nologyform.quota" placeholder="请输入广告名称" clearable/>
                </el-form-item>
                <el-form-item prop="quota" label="广告位置：">
                    <el-input  v-model="nologyform.quota" placeholder="请输入广告名称" clearable/>
                </el-form-item>
                <el-form-item prop="quota" label="开始日期：">
                    <el-input  v-model="nologyform.quota" placeholder="请输入广告名称" clearable/>
                </el-form-item>
                <el-form-item prop="quota" label="结束日期：">
                    <el-input  v-model="nologyform.quota" placeholder="请输入广告名称" clearable/>
                </el-form-item>
                <el-form-item prop="quota" label="广告缩略图：">
                    <el-input  v-model="nologyform.quota" placeholder="请输入广告名称" clearable/>
                </el-form-item>
                <el-form-item prop="quota" label="显示：">
                    <el-switch
                        v-model="value"
                        active-color="#13ce66"
                ...
                <el-form-item prop="quota" label="广告联系人昵称：">
                    <el-input  v-model="nologyform.name" placeholder="请输入广告名称" clearable/>
                </el-form-item>
                <el-form-item prop="quota" label="广告联系人电话：">
                    <el-input  v-model="nologyform.phone" placeholder="请输入广告名称" clearable/>
                </el-form-item>
                <el-form-item label="点击图片跳转链接：">
                    <el-input  v-model="nologyform.url" placeholder="请输入广告名称" clearable/>
                </el-form-item>
            </el-form>
