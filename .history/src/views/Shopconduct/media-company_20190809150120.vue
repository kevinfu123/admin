    ...
    <div class="table-container">
      <el-table ref="returnApplyTable"
        ...
        <el-table-column  label="操作"  align="center">
          <template slot-scope="scope">
            <el-button v-if="scope.row.Freequota ==0" @click="handleClick(scope.row)" type="text" size="small">审核通过</el-button>
            <el-button v-if="scope.row.shopstatus==1" @click="handleClick(scope.row)" type="text" size="small">审核不通过</el-button>
