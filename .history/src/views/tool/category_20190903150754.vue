      ...
      <div style="">
        <el-form :model="cateform"  label-width="120px" style="width: 100%" size="small">
           ...
           <el-form-item label="价格配置：">
              <el-table :data="cateform.member_upgrade"
           ...
           <el-form-item style="width:80%;" label="等级背景图：" prop="icon">
                <el-upload
                  :action="fileAction"
                  name="img"
                  :headers="fileHeaders"
  ...
  export default {
    ...
    methods:{
      ...
      handleRemoveFull(index, row) {
        let member_upgrade = this.cateform.member_upgrade;
      ...
      handleClick() {
        ...
        let tooljson = {
          ...
          member_upgrade:this.cateform.member_upgrade,
        }
