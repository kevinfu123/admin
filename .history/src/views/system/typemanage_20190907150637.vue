        ...
        <el-dialog :title="dialogTitle" width="700px"  @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
            <el-form :model="nologyform" status-icon :rules="rules" label-position="right" label-width="155px" ref="nologyform">
                ...
                <el-form-item prop="index_nav_sort" label="排序：">
                    <el-input v-model.number="nologyform.index_nav_sort"></el-input>
                </el-form-item>
                ...
                <el-form-item  label="排序：">
                    <el-input v-model.number="nologyform.floor_nav_sort"></el-input>
                </el-form-item>
                ...
                <el-form-item  label="排序：">
                    <el-input v-model.number="nologyform.index_needs_sort"></el-input>
                </el-form-item>
