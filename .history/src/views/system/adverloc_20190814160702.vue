       ...
       <div class="table-container" style="margin-top:0;">
        ...
        <el-dialog :title="dialogTitle" width="35%"  @close="handleClose" class="demo-ruleForm" :visible.sync="dialogFormVisible">
            <el-form :model="nologyform" status-icon :rules="rules" label-position="right" label-width="130px" ref="nologyform">
                <el-form-item prop="ggname" label="广告位置：">
                    <el-input  v-model="nologyform.ggname" placeholder="" clearable/>
                </el-form-item>
                <el-form-item prop="pwidth" label="位置宽度：">
                    <el-input  v-model.number="nologyform.pwidth" placeholder="" autocomplete="off" clearable/>
                </el-form-item>
                <el-form-item prop="pheight" label="位置高度：">
                    <el-input  v-model.number="nologyform.pheight" placeholder="" autocomplete="off" clearable/>
                </el-form-item>
