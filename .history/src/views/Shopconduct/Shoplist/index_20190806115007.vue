    ...
    <div class="table-container">
      <el-table ref="returnApplyTable"
        ...
        <el-table-column label="实名认证状态" width="180" align="center">
          <template slot-scope="scope">
                <el-tag type="danger" size="mini" v-if="scope.status=='1'">
                    未申请   
                </el-tag>
                <el-tag type="success" size="mini" v-else-if="scope.status=='2'">
                    已通过
                </el-tag>
                <el-tag type="info" size="mini" v-else-if="scope.status=='3'">
                    未通过
                </el-tag>
